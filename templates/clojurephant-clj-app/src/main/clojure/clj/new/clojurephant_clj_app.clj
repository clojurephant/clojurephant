(ns clj.new.clojurephant-clj-app
  (:require [clj.new.templates :as t]
            [clojure.string :as string]))

(defn clojurephant-clj-app
  [name & args]
  (let [features (into #{} args)
        render (t/renderer "clojurephant-clj-app")
        raw (t/raw-resourcer "clojurephant-clj-app")
    ...
    (println "Generating a project called"
             (:name data)
             "based on the clojurephant-clj-app template.")
